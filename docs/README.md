...
1. Crear `docs/02-lo-que-sea/` con su `index.html` y su carpeta `medios/`.
2. Enlazar `../estilo.css` desde el `<head>` para que herede el diseño.
3. Agregar una tarjeta `<a class="informe" href="02-lo-que-sea/">` en
   `docs/index.html`, copiando la del informe 01.
